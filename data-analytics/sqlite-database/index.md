...
- **Output Structure**
  ...
  [Output Structure →](https://nibzard.github.io/llm-answer-watcher/data-analytics/output-structure/index.md)
...
- **Database Schema**
  ...
  [Schema Reference →](https://nibzard.github.io/llm-answer-watcher/reference/database-schema/index.md)
