...
- [Learn about output modes](https://nibzard.github.io/llm-answer-watcher/user-guide/usage/output-modes/index.md)
- [Automate monitoring runs](https://nibzard.github.io/llm-answer-watcher/user-guide/usage/automation/index.md)
- [See CI/CD examples](https://nibzard.github.io/llm-answer-watcher/examples/ci-cd-integration/index.md)
