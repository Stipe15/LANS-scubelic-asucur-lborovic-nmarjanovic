...
See [Evaluation Framework](https://nibzard.github.io/llm-answer-watcher/evaluation/overview/index.md) for details.
...
- **Rank Extraction**
  ...
  [Rank Extraction →](https://nibzard.github.io/llm-answer-watcher/user-guide/features/rank-extraction/index.md)
...
- **Function Calling**
  ...
  [Function Calling →](https://nibzard.github.io/llm-answer-watcher/user-guide/features/function-calling/index.md)
...
- **Evaluation Framework**
  ...
  [Evaluation Guide →](https://nibzard.github.io/llm-answer-watcher/evaluation/overview/index.md)
...
- **Brand Configuration**
  ...
  [Brand Config →](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/brands/index.md)
