...
- **[Model Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/models/index.md)**: Choose models with web search
- **[Budget Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/budget/index.md)**: Budget for web search costs
- **[Cost Management](https://nibzard.github.io/llm-answer-watcher/user-guide/features/cost-management/index.md)**: Track web search spending
- **[HTML Reports](https://nibzard.github.io/llm-answer-watcher/user-guide/features/html-reports/index.md)**: View web search metadata
