...
- **[Cost Management](https://nibzard.github.io/llm-answer-watcher/user-guide/features/cost-management/index.md)**: Deep dive into cost tracking
- **[Web Search Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/web-search/index.md)**: Understand web search costs
- **[Model Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/models/index.md)**: Choose cost-effective models
- **[Automation](https://nibzard.github.io/llm-answer-watcher/user-guide/usage/automation/index.md)**: Budget controls in CI/CD
