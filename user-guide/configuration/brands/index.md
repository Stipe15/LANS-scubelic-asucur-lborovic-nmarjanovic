...
- **[Intent Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/intents/index.md)**: Design prompts that surface your brand
- **[Rank Extraction](https://nibzard.github.io/llm-answer-watcher/user-guide/features/rank-extraction/index.md)**: Understand how ranking works
- **[Brand Detection](https://nibzard.github.io/llm-answer-watcher/user-guide/features/brand-detection/index.md)**: Deep dive into detection algorithms
- **[Historical Tracking](https://nibzard.github.io/llm-answer-watcher/user-guide/features/historical-tracking/index.md)**: Analyze brand trends over time
