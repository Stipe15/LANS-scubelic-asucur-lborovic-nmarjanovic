...
- [Learn about intent configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/intents/index.md)
- [See complete examples](https://nibzard.github.io/llm-answer-watcher/examples/ci-cd-integration/index.md)
