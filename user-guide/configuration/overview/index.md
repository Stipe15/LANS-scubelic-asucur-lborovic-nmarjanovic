...
- `models`: List of LLM models to query (see [Model Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/models/index.md))
- `use_llm_rank_extraction`: Use LLM to extract rankings (slower, more accurate)
- `budget`: Optional cost controls (see [Budget Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/budget/index.md))
...
See [Brand Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/brands/index.md) for detailed strategies.
...
- `operations`: Optional post-query operations (see [Operations](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/operations/index.md))
...
Web search adds (10-)25 per 1,000 calls depending on the model. See [Web Search Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/web-search/index.md).
...
Check [Model Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/models/index.md) for valid model names.

## Next Steps

Now that you understand the configuration structure, dive into specific sections:

- **[Model Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/models/index.md)**: Choose the right models for your use case
- **[Brand Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/brands/index.md)**: Optimize brand detection strategies
- **[Intent Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/intents/index.md)**: Design effective prompts
- **[Budget Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/budget/index.md)**: Control costs and prevent overruns
- **[Web Search Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/web-search/index.md)**: Enable real-time information retrieval
- **[Operations Configuration](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/operations/index.md)**: Automate post-query analysis

Or jump to usage guides:

- **[CLI Commands](https://nibzard.github.io/llm-answer-watcher/user-guide/usage/cli-commands/index.md)**: Run your first monitoring job
- **[Output Modes](https://nibzard.github.io/llm-answer-watcher/user-guide/usage/output-modes/index.md)**: Understand output formats
- **[Automation](https://nibzard.github.io/llm-answer-watcher/user-guide/usage/automation/index.md)**: Set up scheduled monitoring
