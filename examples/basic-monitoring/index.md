...
See [SQLite Database Guide](https://nibzard.github.io/llm-answer-watcher/data-analytics/sqlite-database/index.md) for more queries.
...
See [Automation Guide](https://nibzard.github.io/llm-answer-watcher/user-guide/usage/automation/index.md) for more options.
...
See [Budget Controls](https://nibzard.github.io/llm-answer-watcher/user-guide/configuration/budget/index.md) for more details.
...
- **Multi-Provider Comparison**
  ...
  [Multi-Provider Example →](https://nibzard.github.io/llm-answer-watcher/examples/multi-provider/index.md)
...
- **Competitor Analysis**
  ...
  [Competitor Analysis →](https://nibzard.github.io/llm-answer-watcher/examples/competitor-analysis/index.md)
...
- **Historical Trends**
  ...
  [Trends Analysis →](https://nibzard.github.io/llm-answer-watcher/data-analytics/trends-analysis/index.md)
...
- **Automation**
  ...
  [Automation Guide →](https://nibzard.github.io/llm-answer-watcher/user-guide/usage/automation/index.md)
...
- **[Configuration Reference](https://nibzard.github.io/llm-answer-watcher/reference/configuration-schema/index.md)** - Complete config schema
- **[Database Schema](https://nibzard.github.io/llm-answer-watcher/reference/database-schema/index.md)** - SQLite database structure
